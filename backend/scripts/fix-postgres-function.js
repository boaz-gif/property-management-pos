...
async function fixPostgresFunction() {
  try {
    console.log('Fixing PostgreSQL function...');
    
    // Drop the existing function
    await pool.query('DROP FUNCTION IF EXISTS calculate_admin_dashboard_metrics(p_admin_id INTEGER, p_date DATE)');
    ...
    console.log('✅ PostgreSQL function fixed successfully!');
